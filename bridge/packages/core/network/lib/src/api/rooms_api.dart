...
class RoomsApi with ApiMixin {
  Future<NetworkResponse<Map<String, dynamic>>> createRoom(
          NetworkRequestRoomCreate body) async =>
      post(to: 'room/create', encodable: body);

  Future<NetworkResponse<Map<String, dynamic>>> deleteRoom(
          NetworkRequestRoom body) async =>
      post(to: 'room/delete', encodable: body);

  Future<NetworkResponse<Map<String, dynamic>>> joinRoom(
          NetworkRequestRoom body) async =>
      post(to: 'room/join', encodable: body);

  Future<NetworkResponse<Map<String, dynamic>>> listRooms(
          NetworkRequestRoomList body) async =>
      post(to: 'room/list', encodable: body);

  Future<NetworkResponse<Map<String, dynamic>>> getRoom(
          NetworkRequestRoom body) async =>
      get(
